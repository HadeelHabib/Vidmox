    ...
    <div className="w-[80%] mx-auto my-[10%] text-white bg-black">
      <div className="flex items-center justify-between">
        <div className="mr-[128px]">
          ...
          <p className="w-full md:w-[50%] mt-4 text-[18px] font-[500] font-[jost] leading-[120%]">
          ...
          <Button className="text-white rounded-[25px] bg-gradient-to-l from-light-blue to-dark-blue font-[600] font-jost px-10 mr-2 my-4">
            Contact Us
          </Button>
        </div>
